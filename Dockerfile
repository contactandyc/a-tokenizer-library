...
COPY --chown=dev:dev . /workspace/a-tokenizer-library
RUN mkdir -p /workspace/build/a-tokenizer-library && \
    cd /workspace/build/a-tokenizer-library && \
    cmake /workspace/a-tokenizer-library && \
