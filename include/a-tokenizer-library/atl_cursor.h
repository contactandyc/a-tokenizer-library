...
/* This is generally meant to match a single document, but can also be used to see if there are any matches
    as it returns true if the first advance call succeeds. */
